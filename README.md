...
- `404.html` – self-contained "signal lost" page (GitHub Pages serves it for unknown paths)
...
- `tools/gate.mjs` – sets the forum access key (`node tools/gate.mjs`); the forum URL is stored AES-encrypted, `--lock` locks it with a random key
